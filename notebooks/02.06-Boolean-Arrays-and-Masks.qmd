...
![png](02.06-Boolean-Arrays-and-Masks_files/02.06-Boolean-Arrays-and-Masks_6_0.png)
...
```
    ...
    /var/folders/xc/sptt9bk14s34rgxt7453p03r0000gp/T/ipykernel_93010/3447948156.py in <module>
    ----> 1 A or B
...
```
    ...
    /var/folders/xc/sptt9bk14s34rgxt7453p03r0000gp/T/ipykernel_93010/2869511139.py in <module>
    ----> 1 (x > 4) and (x < 8)
